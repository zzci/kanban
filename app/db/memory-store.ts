...
const SEED_PROJECTS: Array<{ id: string; name: string; prefix: string }> = [
  { id: DEFAULT_PROJECT_ID, name: 'My Project', prefix: 'PRJ' },
  { id: 'frontend', name: 'Frontend App', prefix: 'FE' },
  { id: 'backend', name: 'Backend API', prefix: 'BE' },
  { id: 'mobile', name: 'Mobile App', prefix: 'MOB' },
  { id: 'infra', name: 'Infrastructure', prefix: 'INF' },
  { id: 'design', name: 'Design System', prefix: 'DS' },
  { id: 'docs', name: 'Documentation', prefix: 'DOC' },
  { id: 'analytics', name: 'Analytics Platform', prefix: 'ANL' },
  { id: 'auth', name: 'Auth Service', prefix: 'AUTH' },
  { id: 'payments', name: 'Payments', prefix: 'PAY' },
  { id: 'search', name: 'Search Engine', prefix: 'SE' },
  { id: 'notifications', name: 'Notifications', prefix: 'NTF' },
  { id: 'ai', name: 'AI Agent', prefix: 'AI' },
  { id: 'devtools', name: 'DevTools', prefix: 'DT' },
  { id: 'testing', name: 'QA & Testing', prefix: 'QA' },
  { id: 'i18n', name: 'Internationalization', prefix: 'I18N' },
]
...
export function createProject(data: { name: string; prefix: string }): Project {
...
export function updateProject(
  id: string,
  changes: Partial<Pick<Project, 'name' | 'prefix'>>,
): Project | undefined {
...
export function createIssue(
  ...
  const prefix = project?.prefix ?? 'ISS'
